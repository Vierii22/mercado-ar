"""
=========================================================
  MercadoAR — Fase 2B (v2)
  Descarga noticias de Ámbito, El Cronista e Infobae Economía
  vía RSS, las filtra por últimas 48hs y las asocia a tickers
  por palabras clave.

  Cambios v2:
  - Fix bug del cutoff (ahora son 48hs reales)
  - Keywords expandidos para mejor matching
  - Límite por sección subido de 10 a 30
  - Matching más inteligente con bordes de palabra
=========================================================
